...
if(CQ.mcm && CQ.mcm.utils.Newsletter){
	...
	CQ.mcm.utils.Newsletter.XEmailService.PUBLISH_DIALOG_PATH = "/apps/myproject/sampleemailservice/components/newsletter/publish/dialog.infinity.json";
...
if(CQ.EmailServiceActionsConfig && CQ.EmailServiceActionsConfig.actionsDialogPath){
	CQ.EmailServiceActionsConfig.actionsDialogPath[CQ.EmailServiceActionsConfig.ADD_SUBSCRIBER] = "/apps/myproject/sampleemailservice/components/actionConfigurations/addSubscriber/dialog.infinity.json";
	CQ.EmailServiceActionsConfig.actionsDialogPath[CQ.EmailServiceActionsConfig.DELETE_SUBSCRIBER] = "/apps/myproject/sampleemailservice/components/actionConfigurations/deleteSubscriber/dialog.infinity.json";
	CQ.EmailServiceActionsConfig.actionsDialogPath[CQ.EmailServiceActionsConfig.AUTO_RESPONDER] = "/apps/myproject/sampleemailservice/components/actionConfigurations/autoResponder/dialog.infinity.json";
}
